  ...
  return (
    <>
      <footer className="w-full p-4 md:h-[15dvh] min-h-fit md:p-4 bg-[#14181c] text-white flex flex-col md:flex-row items-center justify-center gap-4">
        <div className="w-full max-w-337.5 p-4  md:p-4 text-white flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center md:w-1/2 md:max-w-150">
            <img
